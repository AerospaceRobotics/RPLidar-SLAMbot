...
static PyObject * null_on_raise_argument_exception_with_details(const char * classname, const char *  methodname, const char * details) {
    raise_argument_exception(classname, methodname, details);
    return NULL;
}

static PyObject * null_on_raise_argument_exception(const char * classname, const char *  methodname) {
    return null_on_raise_argument_exception_with_details(classname, methodname, NULL);
}

static int error_on_raise_argument_exception_with_details(const char * classname, const char *  methodname, const char * details) {
    raise_argument_exception(classname, methodname, details);
    return -1;
}

static int error_on_raise_argument_exception(const char * classname, const char *  methodname) {
    return error_on_raise_argument_exception_with_details(classname, methodname, NULL);
}

static PyObject * safe_get_attr_string(PyObject * obj, const char * attr_name, 
...
static int double_from_object(double * result,
...
// returns 0 on success, 1 on failure
static int int_from_object(int * result,
    PyObject * obj, const char * attr_name, 
    const char * classname,  const char * method_name, const char * arg_name)
{
    PyObject * attr_value = safe_get_attr_string(obj, attr_name, 
...
static double double_from_tuple(PyObject * tuple, int pos) {
    return PyFloat_AsDouble(PyTuple_GetItem(tuple, pos));
}

static void double_to_tuple(PyObject * tuple, double val, int pos) {
...
static void CoreSLAM_dealloc(CoreSLAM* self) {    
    state_free(&self->state);
    
    Py_TYPE(self)->tp_free((PyObject*)self);
}

static PyObject * CoreSLAM_new(PyTypeObject *type, PyObject *args, PyObject *kwds) {    
    CoreSLAM *self;
...
static int CoreSLAM_init(CoreSLAM *self, PyObject *args, PyObject *kwds) {        
