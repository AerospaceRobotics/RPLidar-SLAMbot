...
{       
    if (!PyArg_ParseTuple(args,"iiiidid", 
        &self->scan_size,
        &self->scan_rate_hz,
...
static PyMemberDef Laser_members[] = {
    ...
    {"scan_rate_hz", T_INT, offsetof(Laser, scan_rate_hz), 0, 
    "laser scan rate in Hertz"},
    {"angle_min_degrees", T_INT, offsetof(Laser, angle_min_degrees), 0, 
    "minimum laser angle in degrees"},
    {"angle_max_degrees", T_INT, offsetof(Laser, angle_max_degrees), 0, 
